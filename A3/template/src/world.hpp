...
private:
    ...
    float m_pebble_group_timer;
    float m_pebble_group_frequency;

    vec2 m_num_pebbles;

    int m_pebbles_spawned;
    int m_pebbles_to_spawn;
    float m_pebble_timer;
    float m_pebble_frequency;
    bool m_spawning_pebbles;

    float m_shoot_pebble_timer;
    float m_shoot_pebble_frequency;
    bool m_can_shoot;

    float m_gravity;

    int m_base_turtle_delay;
    int m_mode3_turtle_delay;
